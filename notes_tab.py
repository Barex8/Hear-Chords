...
class NotesTab(ttk.Frame):
    ...
    def __init__(self,master):
        ...
        checkboxes_frame = ttk.LabelFrame(self, text="Notas seleccionadas")
        ...
        self.check_sharp.grid(column=0,row=0,pady=5,padx=5)
        ...
        ttk.Label(self, text="Solución: (En mayúsculas)").grid(column=0, row=9)
